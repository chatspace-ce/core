# ChatSpace Community Edition License
...
You may not resell ChatSpace Community Edition, repackage it as a paid product, offer it as a hosted or managed service, or build a commercial competing product from it. You may not remove or obscure the project credits, authorship notices, license terms, or ChatSpace Community Edition identity.

If you modify it, say that you modified it. If you share it, include this license.
...
or becomes able to license, to make, have made, use, practice, offer for sale, import
and otherwise run, load and execute the software, in each case subject to the
limitations and conditions in this license. This license does not cover any patent
claims that you cause to be infringed by modifications or additions to the software.
...
granted above terminates immediately.
...
its management and legal affairs.

**your licenses** are all the licenses granted to you for the software under these
terms.

**use** includes all uses of the software, excluding distribution.

**trademark** includes logos, service marks, and trade names.

**patent claim** is any patent claim(s), now owned or hereafter acquired, including
without limitation, method, process, and apparatus claims, in any patent licensable
by grantor.

**your patent license** is the patent license granted under these terms.
